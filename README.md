...
このリポジトリは、アスマティ・辰巳の公開研究・実験ログです。Issueや実験コードは、技術的な観察、再現、比較、制約を共有するために置きます。

ここで公開した研究が、教材、講座、製品、営業導線、収益化計画へ自動的につながることはありません。別の公開物や内部の事業計画で利用する場合も、それぞれ独立した目的、受け手、責任範囲、評価を持たせます。